          ...
          <div className="flex flex-col gap-5">
            ...
            {variant === "newsletter" ? (
              ...
              <>
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center gap-2 bg-white text-darkNavy-1 font-semibold py-3 px-6 rounded-full hover:bg-hoverBlue hover:text-white transition-colors duration-200 w-fit"
                >
                  Let&apos;s Talk
