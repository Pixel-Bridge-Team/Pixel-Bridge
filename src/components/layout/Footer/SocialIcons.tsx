    ...
    <div className="flex items-center gap-3">
      {socials.map(({ name, href, icon }) => (
        <Link
          ...
          aria-label={name}
          className="w-10 h-10 flex items-center justify-center rounded-full bg-[#1E293B] text-white/70 hover:bg-hoverBlue hover:text-white transition-colors duration-200"
        >
          {icon}
        </Link>
      ))}
